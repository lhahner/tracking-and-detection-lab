## Abstract
Here are datasets that are open to use with their content as of setting, type of data e.g. Radar or LIDAR and further accessibaility and size. It might be helpful for any segmationtation, detection and tracking task.

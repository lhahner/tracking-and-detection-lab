...
class TestTransfusionOpenpcdetNuScenesPipeline(unittest.TestCase):
    def test_predict_and_evaluate_from_inference_engine_with_nuscenes_mini(self):
        ...
        checkpoint_file = root_dir / "src/detector/transfusion/model/cbgs_transfusion_lidar.pth"
        config_file = root_dir / "third_party/OpenPCDet/tools/cfgs/nuscenes_models/transfusion_lidar.yaml"
